...
export default function Home({}) {
   ...
   return (
      <main className="min-h-screen flex flex-col bg-gray-950 text-gray-300 py-4">
         ...
         <section
            id="beranda"
            className="px-40 pt-10 flex flex-col justify-center items-center"
         >
            <div className="pt-10 flex flex-col gap-4 max-w-fit">
               ...
               <div className="text-gray-400 text-base text-center max-w-[65rem] leading-8">
                  I’m Henry Carnegie, a Frontend Developer and UI/UX Designer.
                  ...
                  functionality, and solving problem for stakeholder and
         ...
         >
            <div className="pt-10 flex flex-col gap-4 w-full">
               ...
               <div className="grid grid-cols-7 gap-6">
                  <div className="col-span-3 bg-gradient-to-t from-slate-950/10 to-slate-950/100 border border-gray-600/80 rounded-2xl p-4">
                  ...
                  <div className="col-span-4 bg-gradient-to-t from-slate-950/10 to-slate-950/100 border border-gray-600/80 rounded-2xl p-4">
                     <h2 className="text-gray-400 mb-4">Work / Intern :</h2>
                  </div>
               </div>
            </div>
         </section>
